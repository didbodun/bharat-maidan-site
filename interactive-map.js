...
const locations = [
    ...
    },
    {
        ...
        description: "A tribute to Mahatma Gandhi set within the serene Fomin Botanical Garden near Kyiv’s city center.",
        descriptionUk: "Вшанування Махатми Ганді, встановлене в тихому Ботанічному саду ім. Фоміна неподалік центру Києва.",
        descriptionHi: "कीव के शहर केंद्र के पास शांत फोमिन बॉटनिकल गार्डन में स्थापित महात्मा गांधी को समर्पित स्मारक।",
